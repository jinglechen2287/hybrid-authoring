...
const StatesSection = memo(function StatesSection() {
    ...
    const memoObjectStates = useMemo(() => objStates ?? [], [objStates]);
            ...
            actions={
                <div className="flex items-center gap-2">
                    ...
                    <button
                        ...
                        disabled={!selectedObjId || memoObjectStates.length <= 1}
                    >
                        <Minus size={16} />
                    </button>
                </div>
